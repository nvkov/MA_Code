...
for(i in c(31)){
  ...
  load(paste0("C:/Users/Nk/Documents/Uni/MA/Pkw/MobileDaten/generatedData/saved_models/Ctreerun_",i,".RData"))
  ...
  #Concordance index:
    ...
    CIrsf.temp[[j]]<- CItemp$AppCindex$rsf[1:120]
    CIcforest.temp[[j]]<- CItemp$AppCindex$cforest[1:120]
    CICox.temp[[j]]<- CItemp$AppCindex$Cox[1:120]
    CIctree.temp[[j]]<- CItemp$AppCindex$ctree[1:120]
  ...
  print("Save BS")
   ...
   save(BSrpart, file="C:/Users/Nk/Documents/Uni/MA/results_ensembles/BSrpart_train31.RData")
   save(BSrsf, file="C:/Users/Nk/Documents/Uni/MA/results_ensembles/BSrsf_train31.RData")
   save(BScforest, file="C:/Users/Nk/Documents/Uni/MA/results_ensembles/BScforest_train31.RData")
  save(BSCox, file="C:/Users/Nk/Documents/Uni/MA/results_ensembles/BScox_train31.RData")
  save(BSctree, file="C:/Users/Nk/Documents/Uni/MA/results_ensembles/BSctree_train31.RData")
  ...
  save(CIrpart, file="C:/Users/Nk/Documents/Uni/MA/results_ensembles/CIraprt_train31.RData")
  save(CIrsf, file="C:/Users/Nk/Documents/Uni/MA/results_ensembles/CIrsf_train31.RData")
  save(CIcforest, file="C:/Users/Nk/Documents/Uni/MA/results_ensembles/CIcforest_train31.RData")
  save(CICox, file="C:/Users/Nk/Documents/Uni/MA/results_ensembles/CIcox_train31.RData")
  save(CIctree, file="C:/Users/Nk/Documents/Uni/MA/results_ensembles/CIctree_train31.RData")
