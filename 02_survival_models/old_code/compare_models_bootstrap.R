...
png("C:/Users/Nk/Documents/Uni/MA/Graphs/BS_ASeries5000.png")
plot(fitpec, smooth=T, legend.x=100)
dev.off()
...
png("C:/Users/Nk/Documents/Uni/MA/Graphs/CI_ASeries5000.png")
plot(C.Index)
dev.off()
